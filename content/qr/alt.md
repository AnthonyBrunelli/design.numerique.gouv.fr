...
1. Si l’image est décorative, on ne propose aucune alternative textuelle&nbsp;: ce ne serait que du bruit inutile (littéralement dans le cas d’un lecteur vocal) dans la navigation du site.
